...
export default function AvatarPage() {
  ...
  const handleSpeechInput = useCallback((text: string) => {
    ...
    } else if (lowerText.includes('surprised') || lowerText.includes('shock')) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <h1 className="text-3xl font-bold mb-8">AI Avatar Setup with Antispace</h1>
      ...
      {!showAvatar ? (
        <div className="w-full max-w-md">
          <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="mb-6">
              <label className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" htmlFor="avatarId">
                Avatar ID (Optional)
              </label>
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="flex flex-col items-center">
          ...
          {voiceInput && (
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg w-full max-w-md">
              <h3 className="text-lg font-medium mb-2 text-blue-800 dark:text-blue-200">Voice Command</h3>
